...
class TestItemDetailTaxAmount(unittest.TestCase):
    """ItemDetailTaxAmount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemDetailTaxAmount:
        """Test ItemDetailTaxAmount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemDetailTaxAmount`
        """
        model = ItemDetailTaxAmount()
        if include_optional:
            return ItemDetailTaxAmount(
    ...
    def testItemDetailTaxAmount(self):
        """Test ItemDetailTaxAmount"""
