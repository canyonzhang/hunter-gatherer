...
class TestCheckoutOption(unittest.TestCase):
    """CheckoutOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckoutOption:
        """Test CheckoutOption
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckoutOption`
        """
        model = CheckoutOption()
        if include_optional:
