...
class TestErrorLinkDescription(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ErrorLinkDescription:
        """Test ErrorLinkDescription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorLinkDescription`
        """
        model = ErrorLinkDescription()
        if include_optional:
    ...
    def testErrorLinkDescription(self):
        """Test ErrorLinkDescription"""
