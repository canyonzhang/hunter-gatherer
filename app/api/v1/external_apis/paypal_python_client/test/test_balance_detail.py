...
class TestBalanceDetail(unittest.TestCase):
    """BalanceDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceDetail:
        """Test BalanceDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceDetail`
        """
        model = BalanceDetail()
        if include_optional:
            return BalanceDetail(
                ...
                available_balance = openapi_client.models.money.Money(
                    currency_code = '012', 
                    value = '-.2888001528021798096225500850', ),
                withheld_balance = openapi_client.models.money.Money(
                    currency_code = '012', 
                    value = '-.2888001528021798096225500850', )
            )
        else:
