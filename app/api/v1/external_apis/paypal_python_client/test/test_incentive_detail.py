...
class TestIncentiveDetail(unittest.TestCase):
    """IncentiveDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncentiveDetail:
        """Test IncentiveDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncentiveDetail`
        """
        ...
        if include_optional:
            return IncentiveDetail(
                ...
                incentive_amount = openapi_client.models.money.Money(
                    currency_code = '012', 
