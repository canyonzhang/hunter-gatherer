...
class Error409(BaseModel):
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in set(['RESOURCE_CONFLICT']):
            raise ValueError("must be one of enum values ('RESOURCE_CONFLICT')")
        return value
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['The server has detected a conflict while processing this request.']):
            raise ValueError("must be one of enum values ('The server has detected a conflict while processing this request.')")
        return value
