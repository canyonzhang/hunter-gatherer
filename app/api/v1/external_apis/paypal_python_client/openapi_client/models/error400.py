...
class Error400(BaseModel):
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['Request is not well-formed, syntactically incorrect, or violates schema.']):
            raise ValueError("must be one of enum values ('Request is not well-formed, syntactically incorrect, or violates schema.')")
        return value
