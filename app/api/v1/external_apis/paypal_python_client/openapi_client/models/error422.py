...
class Error422(BaseModel):
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in set(['UNPROCESSABLE_ENTITY']):
            raise ValueError("must be one of enum values ('UNPROCESSABLE_ENTITY')")
        return value
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['The requested action could not be performed, semantically incorrect, or failed business validation.']):
            raise ValueError("must be one of enum values ('The requested action could not be performed, semantically incorrect, or failed business validation.')")
        return value
