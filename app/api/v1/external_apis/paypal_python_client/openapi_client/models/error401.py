...
class Error401(BaseModel):
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in set(['AUTHENTICATION_FAILURE']):
            raise ValueError("must be one of enum values ('AUTHENTICATION_FAILURE')")
        return value
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['Authentication failed due to missing authorization header, or invalid authentication credentials.']):
            raise ValueError("must be one of enum values ('Authentication failed due to missing authorization header, or invalid authentication credentials.')")
        return value
